...
int main()
{
    //variables for items quantity (q for quantity)
     ...
     cout<<"\n\t\t\t\tNumber of Burgers:";                                 //here we are taking the quantity of each item
     cin>>qB;
     cout<<"\n\t\t\t\tNumber of Pizza:";
     cin>>qP;
     ...
     int tpFF = qFF*pFF;
                                                                              ...
                                                                              //heere displaing the output of program
     ...
     cout<<"\n\n\t\t\t  "<<qB<<"\t\t\tBurger\t\t\t 90\t\t\t"<<"\t "<<tpB;
     cout<<"\n\t\t\t  "<<qP<<"\t\t\tPizza\t\t\t 180\t\t\t"<<"\t "<<tpP;
     cout<<"\n\t\t\t  "<<qCD<<"\t\t\tCold Drink\t\t 80\t\t\t"<<"\t "<<tpCD;
     cout<<"\n\t\t\t  "<<qFC<<"\t\t\tFried Chicken\t\t 300\t\t\t"<<"\t "<<tpFC;
     cout<<"\n\t\t\t  "<<qFF<<"\t\t\tFrench Fries \t\t 130\t\t\t"<<"\t "<<tpFF;
